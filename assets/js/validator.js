...
Validator.isDate = function (selector, message){
    return{
        selector :selector,
        test: function(value){
            var regex = /^([0]?[1-9]|[1|2][0-9]|[3][0|1])[./-]([0]?[1-9]|[1][0-2])[./-]([0-9]{4}|[0-9]{4})$/
            return regex.test(value)? undefined : message || 'Trường này phải là ngày'
        }
    };
}
...
function sendMail(params) {
    ...
    emailjs.send('service_7pgrii2', 'template_9771609',tempParams)
    .then(function(res){
        alert("Successfully send your message, I will contact you as soon as possible", res.status);
    })
}
